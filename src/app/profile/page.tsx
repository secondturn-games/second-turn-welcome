 ...
 * @property {string | null} image - URL of the game's image or null if not available
 * @property {number} [yearPublished] - The year the game was published (optional)
 * @property {number} [minPlayers] - Minimum number of players (optional)
 * @property {number} [maxPlayers] - Maximum number of players (optional)
 * @property {number} [playingTime] - Average playing time in minutes (optional)
 * @property {number} [minAge] - Minimum recommended player age (optional)
 * @property {string} [description] - Game description (optional)
 * @property {string | null} [thumbnail] - URL of the game's thumbnail image (optional)
 */

/**
 * Represents a user's listing for a board game
 * @interface Listing
 * @property {string} id - Unique identifier for the listing
 * @property {string} title - Title of the listing
 * @property {string | null} description - Detailed description of the listing
 * @property {number | null} price - Price of the listing in the smallest currency unit (e.g., cents)
 * @property {boolean} isFree - Whether the listing is marked as free
 * @property {string} condition - Condition of the game (e.g., 'New', 'Like New', 'Good')
 * @property {boolean} isActive - Whether the listing is currently active
 * @property {Game} game - The game associated with this listing
 * @property {Array<{id: string; url: string}>} images - Array of image objects for the listing
 * @property {string} createdAt - ISO string of when the listing was created
 * @property {string} updatedAt - ISO string of when the listing was last updated
 */
 ...
 * @property {string | null} image - URL of the user's profile image
 * @property {string} createdAt - ISO string of when the user account was created
 * @property {Listing[]} listings - Array of the user's game listings
 */
 ...
 * 
 * Displays the authenticated user's profile information, including their game listings and account stats.
 * Handles loading states, error states, and authentication redirection.
 * 
 * @component
 * @returns {JSX.Element} The rendered profile page with user information and listings
 * 
 * @example
 * ```tsx
...
export default function ProfilePage() {
  /**
   * Authentication session state and router
   * @type {Object}
   * @property {Object} session - The current user session
   * @property {string} status - The authentication status ('loading', 'authenticated', 'unauthenticated')
   */
